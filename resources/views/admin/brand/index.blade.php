        ...
        <div class="table-agile-info">
            <div class="panel panel-default">
                ...
                <div class="row w3-res-tb">
                    ...
                    <div class="col-sm-3">
                        <form action="/search-brand" method="post">
                            @csrf
                    ...
                    <table class="table table-striped b-t b-light">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('brand.edit',['brand'=>$brand->brand_id])}}" class="active" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i></a>
                                    <a onclick="return confirm('Bạn có chắc chắn muỗn xóa thương hiệu này?')" href="{{route('brand.destroy',['brand'=>$brand->brand_id])}}" class="active" ui-toggle-class=""><i class="fa fa-trash-o text-danger text"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
