                    ...
                    <table class="table table-striped b-t b-light">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('categoryproducts.edit',['categoryproduct'=>$categoryProduct->category_id])}}" class="active" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i></a>
                                    <a onclick="return confirm('Bạn chắc chắn muốn xóa danh mục này?')" href="{{route('categoryproducts.destroy',['categoryproduct'=>$categoryProduct->category_id])}}" class="active" ui-toggle-class=""><i class="fa fa-trash-o text-danger text"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
